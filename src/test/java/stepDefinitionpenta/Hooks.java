	...
	public class Hooks {
	    ...
	    public void tearDown(Scenario scenario) throws IOException {
	        if (scenario.isFailed()) {
	            // Take screenshot
	            TakesScreenshot ts = (TakesScreenshot) TC_002.driver;
	            ...
	            File targetFile = new File("C:\\Users\\shiva\\Documents\\workspace-spring-tool-suite-4-4.22.1.RELEASE\\Penta\\screenshots\\bug2.png");
